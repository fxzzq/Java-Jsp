...
<%
		...
		out.println("<br>");
		//插入操作
		String insertSQL = "insert into gateway(gatename,warnrank,warninfo,datetime,publishperson) values('"+ gatename1+"','重度','发现大量浓烟和火苗','"+new java.util.Date()+"','"+request.getSession().getAttribute("loginname")+"')";
