...
<%
		...
		out.println("<br>");
		//插入操作
		String insertSQL = "insert into gateway(gatename,warnrank,warninfo,datetime,publishperson) values('"+ gatename1+"','中度','温度高，环境干燥','"+new java.util.Date()+"','"+request.getSession().getAttribute("loginname")+"')";
