...
<%
		...
		out.println("<br>");
		//插入操作
		String insertSQL = "insert into gateway(gatename,warnrank,warninfo,datetime,publishperson) values('"+ gatename1+"','超重度','该区域综合火险等级1级','"+new java.util.Date()+"','"+request.getSession().getAttribute("loginname")+"')";
